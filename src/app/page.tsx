    ...
    <div className="flex flex-col min-h-dvh">
      <main className="flex-1">
        ...
        <section id="projects" className="bg-secondary/50">
          <div className="container px-4 md:px-6">
            <div className="text-center space-y-4 mb-12">
              <h2 className="text-3xl font-bold font-headline tracking-tighter sm:text-4xl md:text-5xl">Our Projects</h2>
        ...
        <section id="news" className="bg-background">
          <div className="container px-4 md:px-6">
            <div className="text-center space-y-4 mb-12">
              <h2 className="text-3xl font-bold font-headline tracking-tighter sm:text-4xl md:text-5xl">Latest News & Events</h2>
              <p className="max-w-[700px] mx-auto text-muted-foreground md:text-xl">
        ...
        <section id="partners" className="bg-secondary/50">
          <div className="container px-4 md:px-6">
            <div className="text-center space-y-4 mb-12">
              <h2 className="text-3xl font-bold font-headline tracking-tighter sm:text-4xl md:text-5xl">Our Partners & Supporters</h2>
              <p className="max-w-[700px] mx-auto text-muted-foreground md:text-xl">
